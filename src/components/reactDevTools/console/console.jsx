...
export default function Console({ hidden, iframeRef }) {
  ...
  useLayoutEffect(() => {
    ...
    contentWindow.console.error = (...args) =>
      setEntries(entries => [...entries, { type: 'Error', text: argsToText(args) }]);
    contentWindow.console.info = (...args) =>
      setEntries(entries => [...entries, { type: 'Info', text: argsToText(args) }]);
    contentWindow.console.log = (...args) =>
      setEntries(entries => [...entries, { type: 'Log', text: argsToText(args) }]);
    contentWindow.console.warn = (...args) =>
      setEntries(entries => [...entries, { type: 'Warn', text: argsToText(args) }]);
  }, [iframeRef]);
